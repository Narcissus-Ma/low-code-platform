...
const { blocks, isDragging } = storeToRefs(appEditorStore)
...
<!-- toRaw可以拿到非响应式的原始值 -->
<template>
  <!-- 拖动时展示目标区域 by:Narcissus -->
  <div :class="['smooth-dnd-container-wrapper', isDragging && 'smooth-dnd-container-draggable']">
...
.smooth-dnd-container-wrapper {
  width: 100%;
  margin-top: 20px;
}

.smooth-dnd-container-draggable {
  border: 1px dashed var(--color-gray-300);
}
</style>
